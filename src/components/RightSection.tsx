        ...
        <section className='sticky top-0 h-screen flex flex-col space-y-4 right-0 p-1 pe-0 ps-2 laptop:ps-8 max-h-full overflow-y-auto scrollbar-hide'>
            ...
            <div>
                <div className='relative w-full h-full'>
                    ...
                    />
                    <label htmlFor="searchBox" className='absolute top-0 left-5 h-full flex items-center justify-center text-gray-500 peer-focus:text-sky-400'>
                            ...
                            >
                                <div className='space-y-2'>
                                    <div className='flex flex-row items-center space-x-2'>
                                        ...
                                        {/* User info */}
                                        <div className='text-xs text-neutral-500'>
                                            <h5 className='font-semibold text-sm text-white hover:underline'>Manav Verma</h5>
                                            <span>@Manav1924</span>
                                        </div>
                                    </div>
                                </div>
