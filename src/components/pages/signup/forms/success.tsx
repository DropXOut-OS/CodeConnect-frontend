export default function RegisterSuccess() {
    return <div className="relative p-4 w-fit mx-auto max-w-md h-full md:h-auto mt-20">
        <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <a href="/login">
                <button type="button" className="py-2 px-3 text-sm font-medium text-center bg-slate-900 text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:focus:ring-primary-900">
                    Login
                </button>
            </a>
        </div>
